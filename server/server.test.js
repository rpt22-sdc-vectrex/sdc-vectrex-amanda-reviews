...
describe("It should return the correct response for a GET request", () => {
  test("It should response the GET method with the corrected rating if product exist in db", () => {
